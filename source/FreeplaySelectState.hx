...
class FreeplaySelectState extends MusicBeatState{
    public static var freeplayCats:Array<String> = ['main', 'davo', 'extras', 'old', 'joke', 'purgatory', 'covers'];
    ...
    override function create(){
		...
		BG.color = 0xFF00c2ff;
		add(BG);
        categoryIcon = new FlxSprite().loadGraphic(Paths.image('week_icons_' + freeplayCats[curSelected].toLowerCase()));
